...
public class Bk_ksDao extends AbstractDao<Bk_ks, Long> {
    ...
    public static class Properties {
        ...
        public final static Property IsRZ = new Property(9, String.class, "isRZ", false, "isRZ");
    }
    ...
    public Bk_ks readEntity(Cursor cursor, int offset) {
        Bk_ks entity = new Bk_ks( //
            ...
            cursor.isNull(offset + 9) ? null : cursor.getString(offset + 9) // isRZ
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, Bk_ks entity, int offset) {
        ...
        entity.setIsRZ(cursor.isNull(offset + 9) ? null : cursor.getString(offset + 9));
     }
